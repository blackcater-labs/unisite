...
const parseOptions = require(`packages/unisite-gatsby-remark-prismjs/src/parse-options`);
const loadLanguageExtension = require(`packages/unisite-gatsby-remark-prismjs/src/load-prism-language-extension`);
const highlightCode = require(`packages/unisite-gatsby-remark-prismjs/src/highlight-code`);
const addLineNumbers = require(`packages/unisite-gatsby-remark-prismjs/src/add-line-numbers`);
const commandLine = require(`packages/unisite-gatsby-remark-prismjs/src/command-line`);
