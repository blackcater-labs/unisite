...
const loadPrismLanguage = require(`packages/unisite-gatsby-remark-prismjs/src/load-prism-language`);
const handleDirectives = require(`packages/unisite-gatsby-remark-prismjs/src/directives`);
const escapeHTML = require(`packages/unisite-gatsby-remark-prismjs/src/escape-html`);
